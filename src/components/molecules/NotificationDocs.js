    ...
    return (
      <InfoCodeRow id="notificationnDocs" code={selectedCode}>
        ...
        <Text textColor="medium" textSize="body" m={{ b: "4rem" }}>
          ...
          messages to the user. <Tag>isOpen</Tag> & <Tag>onClose</Tag> needs to
          be passed for the notification to work. In addition, <Tag>prefix</Tag>{" "}
          & <Tag>suffix</Tag> can be used to put icons with the notifications.
        </Text>
        {/* IconButton */}
